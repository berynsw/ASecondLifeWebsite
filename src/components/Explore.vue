...
<script>
import PlasticDD from './PlasticDD.vue';
import TinDD from './TinDD.vue';
...
div .Ccontainer{
    ...
    body .plastic{
        background-image: url("../assets/plasticBottle.jpg");
        border-style: solid;
        border-color:#48596C;
        position: absolute;
        top: 50px;
        ...
        body .tinCan{
        background-image: url("../assets/TinCan.jpeg");
        border-style: solid;
        border-color:#48596C;
        position: absolute;
        top: 50px;
        ...
        body .foodWaste{
        background-image: url("../assets/foodWaste.jpg");
        border-style: solid;
        border-color:#48596C;
        position: absolute;
        top: 50px;
